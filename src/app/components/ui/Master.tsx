      ...
      <div className="md:px-10 px-6 bg-[#F9F7F4] py-6 mt-10">
        <div className="flex items-center justify-center w-full relative mt-10">
          <h1 className="font-grotesque font-[400] text-[42px] text-[#655945]">
            Master in <span className="font-[600]">IELTS, TOEFL Exams</span>
          </h1>
          <div className="bg-[#EBC48B] rounded-md  absolute right-5 top-0 md:block hidden">
            <div className="-rotate-[5deg] bg-primary p-2 px-3 flex items-center gap-2 rounded-md hover:rotate-[0deg] transition-all duration-500 ease-in-out text-[10px] lg:text-[13px] text-white font-[500] font-sans justify-center transition-all duration-500 ease-in-out ">
              Read more{" "}
              <svg
                width="22"
                height="29"
        ...
        <div className="carousel-container flex mt-6 min-h-10 relative justify-center items-center w-full h-[250px] ">
          <div
            id="carousel"
            className="w-full text-white flex items-center overflow-x-auto scroll-smooth gap-6 min-h-[200px] pb-4 pt-2 px-2 scrollbar-hide "
          >
            {/* <!-- Card 1 --> */}
            <div>
              <div className=" rounded-md rotate-[2deg] bg-primary group hover:rotate-[0deg] transition-all w-[228px]  duration-500 ease-in-out">
                <div className="carousel-card flex-shrink-0  rounded-md bg-drpColor p-1 pb-4  max-w-[228px] -rotate-[2deg] w-[228px] group-hover:rotate-[0deg] transition-all duration-500 ease-in-out">
                  <img
                  ...
                  <div className="w-full">
                    <p className=" text-md font-thin font-sans text-primary mt-2">
                      IELTS Preparation
                    </p>
                    <p className="text-xs">
                      Focus on all four sections: Listening, Reading, Writing,
                      and Speaking.
                    </p>
                  </div>
                </div>
            ...
            {/* <!-- Card 2 --> */}
            <div>
              <div className=" rounded-md rotate-[2deg] w-[228px] bg-primary group hover:rotate-[0deg] transition-all duration-500 ease-in-out">
                <div className="carousel-card flex-shrink-0  rounded-md bg-drpColor p-1 pb-4  max-w-[228px] -rotate-[2deg] w-[228px] group-hover:rotate-[0deg] transition-all duration-500 ease-in-out">
                  <img
                    src="/images/master/image copy.png"
                    className="h-[121px] w-[228px] rounded-md"
                    alt=""
                  />
                  <div className="w-full">
